...
class RobotArm:
	...
	def follow_target_slowly(self):
		...
		speed_controller_1 = SpeedController(10000, 20000, 0, 100)
		speed_controller_2 = SpeedController(10000, 20000, 0, 100)
		speed_controller_3 = SpeedController(10000, 20000, 0, 100)
		speed_controller_base = SpeedController(10000, 20000, 0, 100)
		...
		#x, y, alpha = self.conversion.cinematica_diretta(90, 0, 0)
		...
		target_1, target_2, target_3 = self.conversion.cinematica_inversa(self.target.x-2, self.target.y, self.target.alpha)
		...
		#x, y, alpha = self.conversion.cinematica_diretta(joint_1.theta, joint_2.theta, joint_3.theta)
